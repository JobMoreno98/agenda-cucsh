<form method="post" id="createEvent">
    ...
    <div>
        ...
        <div>
            ...
            <input class="form-control" type="date" name="fecha_fin[]" value="{{$evento->fecha_inicio}}" id="fecha_fin">
        </div>
        <div>
            <label for="">Hora Inicio</label>
            <input class="form-control" type="time" name="hora_inicio" value="{{$evento->hora_inicio}}" id="hora_inicio">
        </div>
        <h6>Fin</h6>
        <div>
            <label for="">Fecha fin</label>
            <input class="form-control" type="date" name="fecha_fin[]" value="{{$evento->fecha_fin}}" id="fecha_fin">
        </div>

        <div>
            <label for="">Hora Fin</label>
            <input class="form-control" type="time" name="fecha_fin[]" value="{{$evento->hora_fin}}" id="hora_fin">
        </div>
        <hr>
    </div>
    <div id="areas">
        ...
        <select class="form-control" name="area" id="">
            <option selected value="{{ $evento->area_id }}">{{ $evento->area->nombre }}</option>
